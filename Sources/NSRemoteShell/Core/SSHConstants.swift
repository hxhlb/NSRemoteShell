...
enum SSHConstants {
    ...
    static let socketWaitSlice: TimeInterval = 5
    static let shellPollInterval: TimeInterval = 0.05
    static let fileTransferBufferSize = bufferSize
    static let fileTransferRecursiveDepth = 32
